        ...
        <div class="desc-video">
            ...
            <div class="column">
                ...
                <div class="desc">
                    ...
                    $icons = array(
                        'Sueldo aprox.' => '<img src="'.get_template_directory_uri(  ).'/img/icon-money.png" >Sueldo Aproximado',
                        'Vales de despensa' => '<img src="'.get_template_directory_uri(  ).'/img/icon-bono.png" >Vales de Despensa',
                        'Bono Variable' => '<img src="'.get_template_directory_uri(  ).'/img/icon-coins.png" >Bono Variable',
                        'Fondo de ahorro' => '<img src="'.get_template_directory_uri(  ).'/img/icon-savings.png" >Fondo de Ahorro',
                    );
