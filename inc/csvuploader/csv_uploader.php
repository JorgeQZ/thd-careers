...
function render_csv_upload_page() {
    include 'cargar-catalogo-tiendas.php';
}

function render_vacantes_upload_page() {
    include 'cargar-vacantes.php';
}


// function render_csv_upload_page() {
//     include 'upload_acf_csv.php';
// }

// function render_vacantes_upload_page() {
//     include 'upload_vacantes_csv.php';
// }
