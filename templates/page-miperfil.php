...
?>
            ...
            <div class="contenedor-cdt">
                ...
                <label>
                    <input type="radio" name="pr1" value="Oficinas de Apoyo a Tiendas"
                        <?php checked($pr1_actual, 'Oficinas de Apoyo a Tiendas'); ?>> Oficinas de Apoyo a Tiendas
                </label>
                ...
                <label>
                    <input type="radio" name="pr1" value="Centros de Distribución"
                        <?php checked($pr1_actual, 'Centros de Distribución'); ?>> Centros de distribución
                </label>
                ...
                <div class="contenedor-cdt2" style="display: none;">
                    ...
                    <label>
                        <input type="radio" name="pr2" value="Operaciones"
                            <?php checked($pr2_actual, 'Operaciones'); ?>> Operaciones
                    </label>

                    <label>
                        <input type="radio" name="pr2" value="Recursos Humanos"
                            <?php checked($pr2_actual, 'Recursos Humanos'); ?>> Recursos humanos
                    </label>

                    <label>
                        <input type="radio" name="pr2" value="Finanzas" <?php checked($pr2_actual, 'Finanzas'); ?>>
                        Finanzas
                    </label>

                    <label>
                        <input type="radio" name="pr2" value="Marketing" <?php checked($pr2_actual, 'Marketing'); ?>>
                        Marketing
                    </label>
                </div>
...
-->
            ...
            <div class="contenedor detres">
                <div>
                    ...
                    <input type="text" class="validar_tel" name="telefono_celular"
                        value="<?php echo esc_attr($telefono_celular_actual); ?>">
                </div>

                <div>
                    <label for="telefono_fijo">Teléfono fijo</label>
                    <input type="text" class="validar_tel" name="telefono_fijo"
                        value="<?php echo esc_attr($telefono_fijo_actual); ?>">
                </div>
        ...
        <div class="ajustesr">
            ...
            <label>
                <input type="radio" name="pregunta1" value="Sí" <?php checked($pregunta1_actual, 'Sí'); ?>
                    onclick="mostrarSegundaPregunta(true)">
                Sí
            </label><br>

            <label>
                <input type="radio" name="pregunta1" value="No" <?php checked($pregunta1_actual, 'No'); ?>
...
$(document).ready(function() {
    ...
    $('.contenedorgeneralcampos input.req, .contenedorgeneralcampos textarea.req, .contenedorgeneralcampos input.check_terminos')
        .on('input', function() {
            verificarCampos();
        });
...
document.addEventListener('DOMContentLoaded', function() {
    // Mensajes
    const MSG_SIMBOLOS =
        'Este campo solo acepta los siguientes símbolos: "@", ".", "_" , "-" y "´". Otros caracteres no se pueden ingresar.';
